...
const Job: React.FunctionComponent<JobProps> = ({ id, name, location }) => {
    ...
    return (
        <Card as="article" className="m-margin-bottom_16 m-display-flex m-flex-justify_between m-flex-items-center m-flex-direction_column m-flex-direction_row_md">
